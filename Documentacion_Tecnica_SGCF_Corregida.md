...
- Se ha verificado la consistencia de las variables de entorno para MSAL en `.env.example`, `README.md`, `.env` y `src/services/msal.ts` utilizando de manera uniforme `VITE_MSAL_CLIENT_ID` y `VITE_MSAL_TENANT_ID`, evitando fallos de configuraciÃ³n.
